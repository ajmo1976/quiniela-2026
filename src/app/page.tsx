...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center p-6 overflow-hidden bg-slate-50 dark:bg-[#0a0a0c] text-slate-900 dark:text-white transition-colors duration-300">
      ...
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 md:px-6 py-4 glass-card rounded-none border-t-0 border-x-0 border-b border-white/10">
      ...
      <footer className="w-full border-t border-slate-200/10 dark:border-white/5 py-10 mt-20 flex flex-col items-center gap-4 bg-slate-100/50 dark:bg-black/20 backdrop-blur-md relative z-10">
        <div className="flex items-center gap-3">
          <div className="flex flex-col text-center">
            <span className="text-[10px] font-bold text-slate-400 dark:text-white/40 uppercase tracking-widest leading-none mb-1">Desarrollado por</span>
